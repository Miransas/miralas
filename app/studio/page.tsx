      ...
      <main className="min-h-screen overflow-hidden bg-[#f7f7f5] text-[#111111]">
        ...
        <section id="top" className="px-4 pt-4 mt-18 md:px-8 md:pt-6 ">
          <motion.div
            ...
            className="relative mx-auto aspect-[16/10] w-full max-w-[1480px] overflow-hidden rounded-[30px] bg-black shadow-[0_30px_100px_rgba(0,0,0,0.16)] md:aspect-[21/9] md:rounded-[38px]"
          >
            <video
              ref={videoRef}
            ...
            <div className="absolute left-5 right-5 top-5 flex items-start justify-between md:left-8 md:right-8 md:top-8">
              <div className="rounded-full border border-white/15 bg-black/20 px-3.5 py-2 text-[11px] font-medium tracking-[0.12em] text-white/80 backdrop-blur-xl">
                MIRALAS STUDIO
              </div>
              ...
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-black/20 text-white backdrop-blur-xl transition hover:bg-black/35"
              >
            ...
            <div className="absolute inset-x-5 bottom-5 max-w-3xl md:inset-x-8 md:bottom-8">
              ...
              <h1 className="max-w-4xl text-[38px] font-semibold leading-[0.98] tracking-[-0.055em] text-white sm:text-5xl md:text-7xl">
                Build voices that sound real.
              </h1>
              <p className="mt-5 max-w-2xl text-sm leading-6 text-white/65 sm:text-base md:text-lg">
            ...
            <div className="absolute bottom-5 right-5 hidden md:block md:bottom-8 md:right-8">
              <a
                href="#studio"
                className="group flex items-center gap-2 rounded-full bg-white px-4 py-2.5 text-[13px] font-semibold text-black transition hover:gap-3"
              >
                Explore Studio
        ...
        <section id="studio" className="mx-auto max-w-[1240px] px-5 py-24 md:px-8 md:py-32">
          <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr] md:gap-20">
            <div>
              <div className="mb-4 flex items-center gap-2 text-[12px] font-semibold uppercase tracking-[0.14em] text-black/45">
            ...
            <div className="max-w-2xl text-lg leading-8 text-black/55">
              ...
              <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-sm font-medium text-black">
        ...
        {useCases.map((item, index) => (
          <section
            ...
            className="border-t border-black/[0.07] px-5 md:px-8"
          >
            <div className="mx-auto grid max-w-[1240px] gap-10 py-20 md:grid-cols-[0.8fr_1.2fr] md:gap-20 md:py-28">
              <div>
                <div className="mb-5 flex items-center gap-2 text-[12px] font-semibold uppercase tracking-[0.14em] text-black/45">
              ...
              <div>
                ...
                <div className="mt-10 grid gap-3 border-t border-black/[0.08] pt-6 sm:grid-cols-3">
                  {item.points.map((point) => (
                    <div key={point} className="text-sm font-medium text-black/75">
                      <div className="mb-3 h-px w-8 bg-black" />
                      {point}
                    </div>
                  ))}
                </div>
        ...
        <section className="border-t border-black/[0.07] px-5 md:px-8">
          <div className="mx-auto grid max-w-[1240px] gap-8 py-20 md:grid-cols-[1.15fr_0.85fr] md:gap-20 md:py-28">
            <div className="overflow-hidden rounded-[30px] bg-[#101010] p-7 text-white md:p-10">
              <div className="mb-12 flex items-center justify-between">
                <div>
                  <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-white/40">Voice workspace</div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/40">Ready for generation</div>
                  </div>
                </div>

                <div className="flex h-14 items-center gap-1 overflow-hidden rounded-xl bg-white/[0.04] px-4">
                  {Array.from({ length: 48 }).map((_, i) => (
                    <span
                      key={i}
                      className="w-1 shrink-0 rounded-full bg-white/35"
            ...
            <div className="flex flex-col justify-center">
              ...
              <div id="languages" className="mt-8 flex flex-wrap gap-2">
                {languages.map((language) => (
                  <span
                    key={language}
                    className="rounded-full border border-black/10 bg-white px-3.5 py-2 text-xs font-medium text-black/65"
                  >
                    {language}
                  </span>
                ))}
              ...
              <a href="#top" className="mt-10 inline-flex w-fit items-center gap-2 text-sm font-semibold text-black">
                Back to Studio
        ...
        <footer className="border-t border-black/[0.07] px-5 py-10 md:px-8">
          <div className="mx-auto flex max-w-[1240px] flex-col gap-4 text-sm text-black/45 sm:flex-row sm:items-center sm:justify-between">
