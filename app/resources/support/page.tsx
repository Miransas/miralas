  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
          ...
          >
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-3">
              {messages.map((msg, i) => (
                ...
                >
                  <div
                    className={`flex size-6 shrink-0 items-center justify-center rounded-full ${msg.role === "ai" ? "bg-gray-100" : "bg-gray-900"
                      }`}
                  >
                    {msg.role === "ai" ? (
                  ...
                  <div
                    className={`max-w-[75%] rounded-2xl px-3.5 py-2.5 text-[13px] leading-relaxed ${msg.role === "ai"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className={`flex size-14 items-center justify-center rounded-full shadow-xl transition-all duration-300 ${open
