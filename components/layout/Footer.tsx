        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-24 mb-16">
          ...
          <div className="flex-1 lg:max-w-md">
            <Link href="https://miransas.com" className="flex items-center gap-3 mb-6">
              <div className="flex w-20 h-auto items-center justify-center rounded-xl text-background">
                <img
            ...
            >
              <input
                ...
                className="w-full bg-card border border-border focus:border-primary/40 text-foreground text-sm rounded-full py-3.5 pl-5 pr-28 outline-none transition-all placeholder:text-muted-foreground/70"
              />
              <button
                type="submit"
                className="absolute right-1.5 bg-primary text-primary-foreground text-sm font-medium rounded-full px-5 py-2 hover:opacity-90 transition-opacity"
              >
          ...
          <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 gap-8 lg:gap-12 pt-2">
            {footerSections.map((section) => (
              <div key={section.title}>
                <h3 className="font-medium text-foreground mb-5 text-sm">
                  {section.title}
                </h3>
